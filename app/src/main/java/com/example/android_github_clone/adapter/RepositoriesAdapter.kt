...
import com.example.android_github_clone.databinding.ItemRepositoriesBinding
...
class RepositoriesAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return RepositoriesAdapterViewHolder(ItemRepositoriesBinding.inflate(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is RepositoriesAdapterViewHolder) holder.onBind(position)
    }
    ...
    inner class RepositoriesAdapterViewHolder(var binding: ItemRepositoriesBinding) :
